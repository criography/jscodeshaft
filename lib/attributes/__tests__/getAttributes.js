...
import {NON_NODES, printType} from '../../../helpers/tests';

// helpers
const {initHelpers, toAst} = require('../../../helpers/tests');

// this
const {getAttributes} = require('../index');
