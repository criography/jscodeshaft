...
describe('attributes::createAttribute()', () => {
  it('should return `false` on no jscodeshift instance', () => {
    expect(createAttribute()('test')).toBeFalse();
  });
  ...
  describe('attribute name', () => {
    ...
    it('should return `false` on: attribute name starting with a digit', () => {
      expect(
    ...
    it('should return `false` on: attribute name starting with a dash', () => {
      expect(
    ...
    it('should return `false` on: attribute name including punctuation other than a dash', () => {
      expect(
    ...
    it('should return `false` on: attribute name ending with a dash', () => {
      expect(
        isAttribute(tryGetAttributeAst('attribute-'))
      ).toBeFalse();
    });
    ...
    it('should return `true` on: attribute name including but not starting with a number ', () => {
    ...
    it('should return `true` on: attribute name including but not starting with a dash ', () => {
    ...
    it('should return `true` on: string literals', () => {
